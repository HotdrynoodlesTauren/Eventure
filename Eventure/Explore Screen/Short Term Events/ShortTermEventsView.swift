...
class ShortTermEventsView: UIView, UITableViewDataSource, UITableViewDelegate {
    var events: [Event] = [] {
        didSet {
        ...
        private let titleLabel: UILabel = {
            let label = UILabel()
            label.text = "Short Term Events"
            label.textAlignment = .center
            //label.textColor = UIColor(red: 173/255.0, green: 216/255.0, blue: 255/255.0, alpha: 1.0) // Light blue color
